...
async def querojogar(ctx):
    ...
    await ctx.reply("Aprecio sua disposição por jogar! Acabei de mandar mensagem para os <@&707275619754311814> sobre isso! Cazio a seu dispor!")
